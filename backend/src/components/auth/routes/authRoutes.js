...
authRouter.post(
  '/sign-up',
  logEndpointAccess('/sign-up'),
  validationsZod(userSchema),
  signUpUser
)
...
authRouter.post(
  '/sign-in',
  logEndpointAccess('/sign-in'),
  validationsZod(signInSchema),
  signInUser
)
...
authRouter.post(
  ...
  logEndpointAccess('/request-password-reset'),
  requestPasswordResetCtrl
)
authRouter.get(
  '/reset-password/:token',
  logEndpointAccess('/reset-password/:token'),
  verifyResetTokenCtrl
)
authRouter.post(
  '/reset-password/:token',
...
authRouter.get(
  '/verify-email/:token',
  logEndpointAccess('/verify-email/:token'),
  verifyEmail
)

  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <label className="input input-bordered flex items-center gap-2">
        ...
        <input type="text" name="subjectName" className="grow" placeholder="Nombre de Materia" {...register('subjectName')} />
      </label>
      ...
      <label className="input input-bordered flex items-center gap-2">
        ...
        <input type="text" name="name_teacher" className="grow" placeholder="Nombre de Profesor" {...register('name_teacher')} />
      </label>

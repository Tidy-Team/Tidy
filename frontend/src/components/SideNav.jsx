      ...
      <div className="bg-base-100 drawer lg:drawer-open">
              ...
              <div className="flex-0">
                <div className="flex gap-5">
                  ...
                  <div className="dropdown dropdown-end">
                    <div className="tooltip tooltip-bottom" data-tip="Cuenta">
                      <div
                        tabIndex={0}
                        role="button"
                    ...
                    <ul
                      tabIndex={0}
                      className="menu dropdown-content bg-base-200 rounded-box z-[1] mt-3 w-36 p-2 shadow"
                    >
                      <li>
                        <a>Perfil</a>
                      </li>
        ...
        >
          ...
          <aside className="bg-base-300 min-h-screen w-60">
            <div className="bg-base-300 sticky top-0 z-20 hidden items-center gap-2 bg-opacity-90 px-4 py-2 backdrop-blur lg:flex ">
              <Link to="/subjects">
                <button className="btn btn-ghost text-3xl font-bold text-purple-500">
                  Tidy
                </button>
            ...
            <ul className="menu menu-lg px-4 py-0 text-lg">
              <li>
                <Link to="/subjects">
                  <BiSolidBook />
                  Materias

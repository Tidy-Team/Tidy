          ...
          <div className='class="max-w-[100vw] px-6 pb-16 xl:pr-2"'>
            <div className="flex flex-col-reverse justify-between gap-6 xl:flex-row">
              <div className="prose prose-sm md:prose-base w-full max-w-4xl flex-grow pt-10">
                <h1>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias laborum voluptatem assumenda ut dolores
                  suscipit aliquid, corrupti quidem praesentium, blanditiis vel animi doloribus esse modi? Amet dicta aliquam
                  exercitationem! Sit?
                </h1>
                <br />
                <h1>
